<template>
    ...
    <svg :style="style" version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
export default {
	computed: {
		style() {
			return this.$store.getters.getStyle('app', 'navButton')
		},
    },
}
</script>